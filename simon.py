...
if __name__ == "__main__":
    ...
    key = ''
    for key1 in itertools.product(lib,repeat=4):
        keyyyy = hex(str('534543434f4e7b')+key1.encode('hex')+str('7d'))
        print keyyyy
        w = SimonCipher(keyyyy, key_size=96, block_size=64,'ECB')
        t = w.encrypt(0x6d564d37426e6e71)
        if t == 13500967849109763253:
            print 'aaa'
            break
'''
